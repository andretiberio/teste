var $input = $(".typeahead");
    ...
    if (current.name == $input.val()) {
    	$.get('https://api.github.com/users/' + current.name, function (data) {
    		...
    		html += '<div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4"><div class="panel panel-default" ><div class="panel-heading text-left"><a class="text-primary" href="' + html_url + '" class="pull-right btn-lnk small">Ver perfil no github.com</a> <h4 >' + login + '</h4></div>'
